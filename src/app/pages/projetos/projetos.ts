  ...
  projetos: Projeto[] = [
    {
      ...
      imagem: 'https://www.es.gov.br/Media/PortalES/_Profiles/c4d8c6e6/d8d1f292/escola%20do%20futuro-01.png?v=638222624000245250',
      local: 'Santos, SP',
      beneficiados: '1.200',
      ano: 2018,
      detalhes: [
    ...
    },
    {
      ...
      imagem: 'https://deltasaneamento.com.br/media/image/noticias-artigos/agualimpaLogo.jpg',
    ...
    },
    {
      ...
      imagem: 'https://www.apuiares.ce.gov.br/fotos/428/Capa428.jpg',
      local: 'São Paulo, SP',
      beneficiados: '8.500',
      ano: 2020,
      detalhes: [
    ...
    },
    {
      ...
      imagem: 'https://mulheres-na-energia.mitsidi.com/static/img/parceiros/mulheres-pela-eficiencia.png',
      local: 'Nacional',
      beneficiados: '3.200',
      ano: 2019,
      detalhes: [
    ...
    },
    {
      ...
      imagem: 'https://assets-api-file-prod.s3.amazonaws.com/files/f6587d2b3c482d3d9e99-Capa%20Conte%C3%BAdos%20Sebrae%20Play.jpg',
      local: 'Macaé, RJ',
      beneficiados: '620',
      ano: 2021,
      detalhes: [
    ...
    },
    {
      ...
      imagem: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQzxRxQzX3sIaEKQzZMIT1voQD6Mhkz_7CkQ&s',
